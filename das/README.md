...
### Installation guide for "regular" NVIDIA setup
https://docs.nvidia.com/datacenter/cloud-native/openshift/25.3.2/install-gpu-ocp.html

### Running the workload

```
DAS=(false|true) ITERATIONS=(4|16) ./kube-burner-ocp init --local-indexing --config kube-burner-whisper.yml
```

Each iteration includes 2 jobs started simultaneously: whisper-transcription-medium and whisper-transcription-large
